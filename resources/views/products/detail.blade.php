...
{{-- 					<div class="container service1-items col-sm-2 col-md-2 pull-left">
 ...
 --}}				
				<div class="col-md-7">
					...
					<p>
					<div class="col-md-3">
					Sale Price: <div class="product-price"><h3><span class="label label-default label-success">৳ {{number_format(($product->salePrice()),2,'.',',')}}</span></h3>
					</div>
					</div>
					<div class="pull-left col-md-3">
					<span>
					Actual Price: <h3><span class="label label-default label-default" style="text-decoration: line-through;">৳ {{number_format($product->price,2,'.',',')}}
					</span>
					</h3>
					</div>
					</p>
        ...
        <div class="col-sm-8">
            <div class="panel panel-white post panel-shadow">
                ...
                <div class="post-description"> 
					...
					{!!Form::textarea('comment',null,['class'=>'form-control','rows'=>3, 'placeholder'=>'Type your review here..'])!!}
					</p>
